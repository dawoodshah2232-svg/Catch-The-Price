...
const routes = [
  ...
  { path: '/ae/login', status: 200, contains: 'CatchThePrice' },
  { path: '/ae/signup', status: 200, contains: 'CatchThePrice' },
  { path: '/ae/forgot-password', status: 200, contains: 'CatchThePrice' },
  { path: '/ae/account', status: 200 },
  { path: '/ae/account/saved', status: 200 },
  { path: '/ae/account/alerts', status: 200 },
  { path: '/ae/account/notifications', status: 200 },
  { path: '/ae/account/history', status: 200 },
  { path: '/ae/account/settings', status: 200 },
