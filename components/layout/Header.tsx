...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full ui-header backdrop-blur-xl border-b transition-colors shadow-[0_4px_24px_rgba(24,52,43,0.05)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="hidden lg:flex items-center justify-between h-[76px] gap-5">
