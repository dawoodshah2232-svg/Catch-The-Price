  ...
  return (
    <div className="group relative rounded-2xl bg-white border border-[#DDE7E3] hover:border-[#A9CBBE] hover:shadow-[0_14px_34px_rgba(29,71,57,.10)] transition-all duration-200 flex flex-col overflow-hidden">
      <div className="relative w-full pt-[75%] bg-[#F7FAF8] overflow-hidden">
        ...
        {discountPercent > 0 && (
          <div className="absolute top-2.5 left-2.5 flex items-center px-2 py-1 rounded-lg text-[11px] font-extrabold bg-[#DDF8EB] text-[#08784B] border border-[#B9E7D2]">
            ↓ {discountPercent}%
          </div>
        )}
      ...
      <div className="p-3.5 sm:p-4 flex-1 flex flex-col justify-between">
        ...
        <div className="mt-3 pt-3 border-t border-[#E4ECE8]">
          <div className="flex items-baseline justify-between gap-1 mb-2">
            <div>
              <span className="text-[10px] text-[#73858D] block uppercase tracking-wider font-semibold">Best Price</span>
              ...
              {product.originalPrice > product.currentBestPrice && (
                <div className="text-[11px] text-[#8A999F] line-through mt-0.5 font-medium">
