            ...
            >
              ...
              <div className="flex items-center justify-between sm:justify-end gap-3 pt-2 sm:pt-0 border-t sm:border-t-0 border-[#EDF2F0]">
                ...
                <a
                  ...
                  className={`inline-flex items-center justify-center gap-1.5 min-h-[42px] px-3.5 rounded-xl text-[11px] font-extrabold transition-colors shrink-0 ${
                    isBest
                      ? 'bg-[#0B8F58] hover:bg-[#08784B] text-white'
                      : 'bg-[#F0F7F4] hover:bg-[#E5F3ED] text-[#08784B] border border-[#CFE3DB]'
                  }`}
                >
